...
// Function to select all teacher checkboxes
...
document.getElementById("downloadExcelBtn").addEventListener("click", function() {
  ...
  wb.Workbook.Views[0] = {
    ...
    fitToWidth: 1, // Fit content to one page width
    fitToHeight: false, // Don't fit content to page height
  };

  // Create a new worksheet with the adjusted options
  ...
  XLSX.writeFile(wb, 'invigilation_schedule.xlsx');
});
